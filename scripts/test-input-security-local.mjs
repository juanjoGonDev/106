...
assert.notEqual(profileProbe.response.status, 500, JSON.stringify(profileProbe.payload));
log('Read-only profile lookup treats SQL-like nickname input as data');

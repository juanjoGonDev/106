-- Preserve the existing canonical account-player projection exactly. The new
-- stable player_id is an administrative identity boundary and must not regress
-- the current daily quota / lifetime summary owner.
